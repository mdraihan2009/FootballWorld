...
document.getElementById("playerHeroPhoto").src = player.photo;

document.getElementById("playerHeroName").innerText = player.name;

document.getElementById("playerHeroClub").innerText =
stats.team.name;
...
<button id="favBtn" class="hero-btn" style="margin-top:15px;">
⭐ Add to Favorite
</button>
...
<div class="badge">🏟 ${stats.team.name}</div>

<div class="badge">🏆 ${stats.league.name}</div>

<div class="badge">🌍 ${player.nationality}</div>
...
<div class="badge">
👕 #${stats.games.number ?? "N/A"}
</div>

<div class="badge">
${stats.games.captain ? "👑 Captain" : "⭐ Player"}
</div>
...
<div class="stat-box premium-stat">
...
<div class="stat-box premium-stat">
⭐<br><b>Rating</b><br>${stats.games.rating
